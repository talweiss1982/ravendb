    ...
    public class DocumentDatabase : IDisposable
    {
        ...
        public void Initialize(InitializeOptions options = InitializeOptions.None)
        {
            try
            {
                ...
                var landlordHolder = new DatabaseTaskRunner
                {
                ...
                landlordHolder.NotifyFeaturesAboutStateChange();
                landlordHolder.ClusterTransaction();
                }
                catch (Exception)
                {
                    Dispose();
        ...
        internal class DatabaseTaskRunner
        {
            ...
            {
                Task.Factory.StartNew(ExecuteClusterTransaction, Cts, TaskCreationOptions.LongRunning);
            }
